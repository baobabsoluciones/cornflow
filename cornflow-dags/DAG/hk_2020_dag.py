...
from hackathonbaobab2020 import get_solver, Instance, solvers
...
config["properties"]["solver"]["enum"] = list(solvers.keys())
config["properties"]["solver"]["default"] = "ortools"
...
hackathon_task = PythonOperator(
    task_id="hk_2020_dag", python_callable=solve_hk, dag=dag
)
