...
if __name__ == "__main__":
    # solve problem with very very bad heuristic:
    solution_dict = test_pedido_sugerido("algorithm1")
    print(solution_dict)
    # solve problem with slightly less-bad heuristic:
    solution_dict = test_pedido_sugerido("algorithm2")
    print(solution_dict)
