...
def upgrade():
    ...
    op.add_column('executions', sa.Column('data', postgresql.JSON(astext_type=sa.Text()), nullable=True))
    op.add_column('executions', sa.Column('data_hash', sa.String(length=256), nullable=True))
    ...
    op.add_column('instances', sa.Column('data_hash', sa.String(length=256), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.alter_column('instances', 'data',
               existing_type=postgresql.JSON(),
               nullable=False)
    op.drop_column('instances', 'data_hash')
    op.add_column('executions', sa.Column('execution_results', postgresql.JSON(), nullable=True))
