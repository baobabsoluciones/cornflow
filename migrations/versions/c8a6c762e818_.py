...
Create Date: 2021-06-07 20:11:22.386875
...
revision = 'c8a6c762e818'
down_revision = 'c2db9409cb5f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['api_view_id'], ['api_view.id'], ),
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('action_id', 'api_view_id', 'role_id')
    )
