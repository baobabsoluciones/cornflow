...
def upgrade():
    op.add_column(
        'deployed_dags',
        sa.Column('instance_schema', postgresql.JSON(astext_type=sa.Text()), nullable=True)
    )
    op.add_column(
        'deployed_dags',
        sa.Column('solution_schema', postgresql.JSON(astext_type=sa.Text()), nullable=True)
    )
    op.add_column(
        'deployed_dags',
