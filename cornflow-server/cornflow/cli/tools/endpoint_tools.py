...
class EndpointGenerator:
    ...
    def generate_endpoint_put_bulk(self):
        ...
        res += (
            SP8
            + 'description="Updates several rows of the table or adds them if they do not exist",\n'
        )
        res += SP8 + f'tags=["{self.app_name}"],\n'
        res += "    )\n"
        res += f"    {AUTH_DECORATOR}\n"
