...
class TestExperimentCore(TestCase):
    ...
    def test_get_solver_config_without_remove_unknow_and_solver_config(self):
        ...
        res = self.class_to_use.get_solver_config(config, remove_unknown=False)
        self.assertEqual(res, {"MIPGapAbs": 5, "msg": True})
    ...
    def test_get_solver_config_with_remove_unknow_without_solver_config(self):
        ...
        res = self.class_to_use.get_solver_config(config, remove_unknown=True)
        self.assertEqual(res, {"MIPGapAbs": 5})

    def test_get_solver_config_empty(self):
        config = dict(
        )
        res = self.class_to_use.get_solver_config(config)
    ...
    def test_get_solver_config(self):
        ...
        res = self.class_to_use.get_solver_config(config)
        self.assertEqual(res, {"TimeLimit": 600, "MIPGap": 0.001})
