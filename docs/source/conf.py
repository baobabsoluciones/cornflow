...
sys.path.insert(0, os.path.abspath("../../cornflow-server/"))
sys.path.insert(0, os.path.abspath("../../libs/client/"))
...
OPENAPI_FILE = os.path.join(
    os.path.dirname(__file__), "..", "..", "cornflow-server", "cornflow", "static", "v1.json"
)
redoc = [
    {
