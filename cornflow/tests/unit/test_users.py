...
class TestUserEndpoint(TestCase):
    ...
    def setUp(self):
        ...
        self.user_2 = dict(name='testname2', email='test2@test.com', password='testpassword2', admin=False)
    ...
    def modify_info(self, user_asks, user_asked, payload):
        ...
        return self.client.put(url, data=json.dumps(payload), follow_redirects=True,
                               headers={"Content-Type": "application/json", "Authorization": 'Bearer ' + token})
