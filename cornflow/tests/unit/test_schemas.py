...
class TestSchemaEndpoint(CustomTestCase):
    ...
    def test_get_schema(self, Airflow):
        ...
        instance.get_schemas_for_dag_name.return_value = \
            dict(instance = self.schema, solution = self.schema)
        schemas = self.get_one_row(self.url + 'pulp/', {}, expected_status=200, check_payload=False)
